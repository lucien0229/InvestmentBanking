...
-- target function owner to have CREATE on the containing schema; restore the
-- closed privilege only for the ownership transfer and revoke it immediately
-- afterward.
GRANT CREATE ON SCHEMA source, object_store TO app_source_owner;
