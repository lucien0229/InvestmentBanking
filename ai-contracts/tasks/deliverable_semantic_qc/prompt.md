...
Propose location-specific findings: observed condition, expected contract, severity proposal and remediation proposal. Do not invent an observed difference or claim a visual inspection that the supplied coverage does not establish.
