...
from services.office.inspect_teaser_presentation import inspect
from services.office.teaser_presentation import build
...
def fixture():
    ...
    return {
        "schema_version": "1.0.0", "task_definition": "teaser_content_draft", "status": "proposal_only",
        "revision_id": "11111111-1111-4111-8111-111111111111", "template_version": "teaser-1.0.0",
...
class TeaserObserverTest(unittest.TestCase):
    def test_render_and_adversarial_native_reader_checks(self):
        with tempfile.TemporaryDirectory() as tmp:
            ...
            result = inspect(data, root / "missing-chart.pptx", root / "teaser.pdf")
