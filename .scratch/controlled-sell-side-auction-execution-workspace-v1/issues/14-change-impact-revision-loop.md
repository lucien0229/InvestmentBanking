# 14 — Turn a material source change into Impact and a new Revision

**What to build:** Process a correction, new Source version, changed Assumption, Decision, audience, purpose, or source perimeter as an explicit material-change loop. Deterministic dependency closure and the governed `semantic_change_impact_proposal` identify candidate effects; the Banker resolves exact Impact actions and produces a new immutable Revision without rewriting prior authority.
