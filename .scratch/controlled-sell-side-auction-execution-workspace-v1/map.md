...
- Ticket 07 production evidence remains deferred for the host-owned Public Fetch Coordinator/sandbox (including DNS-rebinding and live robots checks), Supabase TUS/Storage RLS, isolated quarantine scanner/Outbox, KMS-backed Account/Deal Protected Object Gateway, complete async Job/idempotency wiring, authenticated remote acceptance, and rollback/restore; local/development evidence must not be promoted to production proof.
