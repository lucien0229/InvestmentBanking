export default function HomePage() {
  return (
    <main id="main-content" style={{ maxWidth: 920, margin: "0 auto", padding: 48 }}>
      <a href="#main-content" style={{ position: "absolute", left: -10000 }}>Skip to main content</a>
      <p style={{ fontFamily: "monospace", fontSize: 12, letterSpacing: 1 }}>DEAL CONTROL / V1 REFERENCE SEAM</p>
