export default function PricingPage() {
  return (
    <main id="main-content" style={{ maxWidth: 980, margin: "0 auto", padding: 48 }}>
      ...
      <p style={{ fontFamily: "monospace", fontSize: 12, letterSpacing: 1, marginTop: 32 }}>DEAL CONTROL / PRICING</p>
